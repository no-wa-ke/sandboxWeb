...
{
	$to = 'mty1245@mac.com';
	$subject = 'THE GIFTED _CONTACT の送信';
	...
	$message .= '<tr><td valign="top" style="background-color: #ffffff;"><b>NAME:</b></td><td>' . htmlentities($_REQUEST["custom_U1515"],ENT_COMPAT | ENT_HTML401,'UTF-8') . '</td></tr>';
	...
	$message .= '<tr><td valign="top" style="background-color: #ffffff;"><b>MESSAGE:</b></td><td>' . htmlentities($_REQUEST["custom_U1542"],ENT_COMPAT | ENT_HTML401,'UTF-8') . '</td></tr>';
	$message .= '<tr><td valign="top" style="background-color: #ffffff;"><b>SUBJECT:</b></td><td>' . htmlentities($_REQUEST["custom_U1550"],ENT_COMPAT | ENT_HTML401,'UTF-8') . '</td></tr>';
	...
	if($sent)
	{
		echo '{"FormResponse": { "success": true,"redirect":"thankyou.html"}}';
