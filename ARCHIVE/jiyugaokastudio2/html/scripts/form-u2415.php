...
{
	$to = 'info@jiyugaokastudio.com';
	$subject = 'reserve フォーム の送信';
	...
	$message .= '<tr><td valign="top" style="background-color: #ffffff;"><b>お名前:</b></td><td>' . htmlentities($_REQUEST["custom_U2416"],ENT_COMPAT | ENT_HTML401,'UTF-8') . '</td></tr>';
	...
	$message .= '<tr><td valign="top" style="background-color: #ffffff;"><b>予約希望時間帯:</b></td><td>' . htmlentities($_REQUEST["custom_U2429"],ENT_COMPAT | ENT_HTML401,'UTF-8') . '</td></tr>';
	$message .= '<tr><td valign="top" style="background-color: #ffffff;"><b>連絡先電話番号:</b></td><td>' . htmlentities($_REQUEST["custom_U2441"],ENT_COMPAT | ENT_HTML401,'UTF-8') . '</td></tr>';
	$message .= '<tr><td valign="top" style="background-color: #ffffff;"><b>ご利用目的:</b></td><td>' . htmlentities($_REQUEST["custom_U2435"],ENT_COMPAT | ENT_HTML401,'UTF-8') . '</td></tr>';
	$message .= '<tr><td valign="top" style="background-color: #ffffff;"><b>ご利用人数:</b></td><td>' . htmlentities($_REQUEST["custom_U2722"],ENT_COMPAT | ENT_HTML401,'UTF-8') . '</td></tr>';
	...
	$headers = 'From:  info@jiyugaokastudio.com' . "\r\n" . 'Reply-To: ' . $formEmail .  "\r\n" .'X-Mailer: Adobe Muse 6.0.751 with PHP/' . phpversion() . "\r\n" . 'Content-type: text/html; charset=utf-8' . "\r\n";
	
	$sent = @mail($to, $subject, $message, $headers);
	
	if($sent)
	{
		echo '{"FormResponse": { "success": true,"redirect":"../phone/thank-you.html"}}';
