...
function emailFormSubmission()
{
	...
	$message .= '<tr><td valign="top" style="background-color: #ffffff;"><b>お名前:</b></td><td>' . htmlentities($_REQUEST["custom_U1738"],ENT_COMPAT | ENT_HTML401,'UTF-8') . '</td></tr>';
	...
	$message .= '<tr><td valign="top" style="background-color: #ffffff;"><b>予約希望時間帯:</b></td><td>' . htmlentities($_REQUEST["custom_U1743"],ENT_COMPAT | ENT_HTML401,'UTF-8') . '</td></tr>';
	$message .= '<tr><td valign="top" style="background-color: #ffffff;"><b>連絡先電話番号:</b></td><td>' . htmlentities($_REQUEST["custom_U1768"],ENT_COMPAT | ENT_HTML401,'UTF-8') . '</td></tr>';
	$message .= '<tr><td valign="top" style="background-color: #ffffff;"><b>ご利用目的:</b></td><td>' . htmlentities($_REQUEST["custom_U1773"],ENT_COMPAT | ENT_HTML401,'UTF-8') . '</td></tr>';
	$message .= '<tr><td valign="top" style="background-color: #ffffff;"><b>ご利用人数:</b></td><td>' . htmlentities($_REQUEST["custom_U2717"],ENT_COMPAT | ENT_HTML401,'UTF-8') . '</td></tr>';
