...
var getW = $('#monstereyes').width();
var getH = $('#monstereyes').height();        


 $("<div id='" + eyecontainer + "'><div id='" + pupil + "'></div></div>").appendTo("#monstereyes");
...
//  $(eyecontainer).css({left:eyeposx, top:eyeposy});
  $(eyecontainer).css({left:getW/2, top:eyeposy});
  ...
  $(eyecontainer).css({ position: 'relative',background:'#FFFFFF', overflow:'hidden','border-radius': '50%'});
...
var eye =  DrawEye("eye1", "pupil1", 0, 0, 100);
